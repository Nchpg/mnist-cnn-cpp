...
public:
    ...
    inline scalar_t &operator()(size_t r, size_t c)
    {
        return data_[r * cols_ + c];
    }
    inline const scalar_t &operator()(size_t r, size_t c) const
    {
        return data_[r * cols_ + c];
    }
    ...
    const std::vector<scalar_t> &get_raw_vector() const noexcept
    {
        return data_;
    }
    std::vector<scalar_t> &get_raw_vector() noexcept
    {
        return data_;
    }
    scalar_t *data() noexcept
    {
        return data_.data();
    }
    const scalar_t *data() const noexcept
    {
        return data_.data();
    }
